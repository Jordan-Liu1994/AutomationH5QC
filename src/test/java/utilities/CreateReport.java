...
public class CreateReport {
	...
	public void generateReport(String nameOfReport, String platform, String browser, String javaVersion, String automationAuthor) {
		eR = new ExtentReports();
		sR = new ExtentSparkReporter(pathOfReport + nameOfReport + "-report.html");
		eR.attachReporter(sR);
		eR.setSystemInfo("Platform", platform);
